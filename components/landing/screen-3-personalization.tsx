...
const PROBLEMS: {
...
}[] = [
  {
    id: "donor",
    icon: MessageCircle,
    title: "Donantes que escriben en WhatsApp + Mail al mismo tiempo",
    hint: "Cross-platform · cuando alguien insiste por dos canales",
    color: "rgb(124, 122, 237)",
  },
  {
    id: "mye",
    icon: FileSignature,
    title: "Reportes M&E que esperan mi firma antes del cierre del trimestre",
    hint: "Adjuntos con deadline · Yunguilla / Q1 / desembolsos",
    color: "rgb(245, 165, 36)",
  },
  {
    id: "wg",
    icon: Users,
    title: "Working groups con 30 personas en CC y nadie sabe quién decide",
    hint: "CCs largos · 'to me' vs 'for visibility'",
    color: "rgb(61, 214, 140)",
  },
  {
    id: "compliance",
    icon: Paperclip,
    title: "Adjuntos de auditoría que se acumulan sin llenar",
    hint: "Anti-corrupción · Due diligence · Beneficiarios finales",
    color: "rgb(229, 72, 77)",
  },
]
